local a = {}
local b = nil
local c = module("rng-weapons", "cfg/weapons")
local d = {
            ...
            RageUI.DrawContent(
                ...
                function()
                    ...
                    RageUI.Button(
                        ...
                        function(g, h, i)
                            if i then
                                TriggerServerEvent("RNG:selectLoadout", b)
...
RegisterNetEvent("RNG:gotLoadouts")
AddEventHandler(
    "RNG:gotLoadouts",
    function(j)
        a = j
        ...
        if l then
            ...
            local p = function(n)
                if IsControlJustPressed(1, 38) then
                    TriggerServerEvent("RNG:getPoliceLoadouts")
                    RageUI.Visible(
                        RMenu:Get("policeloadouts", "main"),
            ...
            for e, f in pairs(d) do
                tRNG.createArea("police_loadouts_" .. e, f, 1.5, 6, m, o, p, {locationId = e})
            end
        end
    end
)
