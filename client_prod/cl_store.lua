...
local function a2(K)
    l = true
    TriggerServerEvent("RNG:setInVehicleTestingBucket", true)
    z = tRNG.getPlayerCoords()
    w = 1
    ...
    m = tRNG.spawnVehicle(K, a4.x, a4.y, a4.z, a5, true, false, false)
    n = GetGameTimer()
end
                ...
                function()
                    ...
                    if next(b) then
                        ...
                        RageUI.ButtonWithStyle(
                            ...
                            function(m, q, r)
                                if r then
                                    tRNG.OpenUrl("https://store.rngstudios.co.uk/")
                                end
                            end
                        )
                    end
                ...
                function()
                    ...
                    if U.manuallyRedeemable then
                        RageUI.ButtonWithStyle(
                            ...
                            function(X, Y, Z)
                                if Z then
                                    TriggerServerEvent("RNG:getStoreLockedVehicleCategories")
                                end
                            end,
                            RMenu:Get("store", "redeem")
                        )
                            ...
                            function(X, Y, Z)
                                if Z then
                                    if isInGreenzone then
                                        TriggerServerEvent("RNG:startSellStoreItem", d)
                                    else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if T(U) then
                                    TriggerServerEvent("RNG:redeemStoreItem", d, e)
                                else
                ...
                function()
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                if
                                    tRNG.canAnim() and tRNG.getPlayerCombatTimer() == 0 and tRNG.getPlayerVehicle() == 0 and
                                        not tRNG.isPlayerInRedZone() and
                                        tRNG.getPlayerBucket() == 0
                                 then
                                    a2(g)
                                else
                    ...
                    RageUI.ButtonWithStyle(
                        ...
                        function(X, Y, Z)
                            if Z then
                                ...
                                TriggerServerEvent("RNG:setInVehicleTestingBucket", false)
...
local function az()
    if l then
        ...
        local vehicle, aA = tRNG.getPlayerVehicle()
...
tRNG.createThreadOnTick(az)
function tRNG.isInStoreTesting()
    return l
end
RegisterNetEvent(
    "RNG:storeDrawEffects",
    function()
...
RegisterNetEvent(
    "RNG:setStoreLockedVehicleCategories",
    function(aB)
        c = aB
    end
)
RegisterNetEvent("RNG:OpenStoreMenu")
AddEventHandler(
    "RNG:OpenStoreMenu",
    function()
...
RegisterCommand(
    "store",
    function()
        TriggerServerEvent("RNG:OpenStore")
    end
)
RegisterNetEvent(
    "RNG:setStoreRankName",
    function(aC)
        i = aC
    end
)
