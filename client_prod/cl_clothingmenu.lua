...
RMenu.Add("RNGclothing", "changePed", RageUI.CreateSubMenu(RMenu:Get("RNGclothing", "mainMenu"), "", "Change Gender"))
RMenu.Add(
    "RNGclothing",
    "changeClothing",
    RageUI.CreateSubMenu(RMenu:Get("RNGclothing", "mainMenu"), "", "Change your Clothes")
)
IsInClothingMenu = false

RMenu.Add("RNGclothing", "clearProps", RageUI.CreateSubMenu(RMenu:Get("RNGclothing", "mainMenu"), "", "Clear Props"))
local a = {
...
local r = {
    ...
    vector3(-2152.287842, 5232.096680, 18.782818),
        ...
        while true do
            ...
            for H = 1, #r do
                ...
                elseif s == H then
                    ...
                    if not RageUI.Visible(RMenu:Get("RNGclothing", "changeClothing")) then
                        F()
                    end
                end
            end
...
RageUI.CreateWhile(
    ...
    function()
        if not n then
            if RageUI.Visible(RMenu:Get("RNGclothing", "mainMenu")) then
                RageUI.DrawContent(
                    ...
                    function()
                        RageUI.Button(
                            ...
                            RMenu:Get("RNGclothing", "changeClothing")
                        )
                        if not inOrganHeist then
                            RageUI.Button(
                                ...
                                RMenu:Get("RNGclothing", "changePed")
                            )
                        end
                        RageUI.Button(
                            "~y~Wardrobe",
                        ...
                        if PlayerIsInGang then
                            RageUI.Button(
                                ...
                                function(L, M, N)
                                    if N then
                                        TriggerServerEvent("RNG:applyGangFit", gangID)
                                    end
                                end
                            )
                        end
                        RageUI.Button(
                            "Apply Outfit Code",
                            "Applys an outfit code given by a player with ~y~RNG Plus~w~ or ~y~RNG Platinum~w~.",
                            {RightLabel = "→→→"},
                            true,
                            function(L, M, N)
                                if N then
                                    tRNG.clientPrompt(
                                        ...
                                        function(O)
                                            ...
                                            if #P == 5 then
                                                TriggerServerEvent("RNG:applyOutfitCode", string.upper(P))
                                            else
                        ...
                        RageUI.Button(
                            ...
                            RMenu:Get("RNGclothing", "clearProps")
                        )
                    end
                )
            end
            if RageUI.Visible(RMenu:Get("RNGclothing", "changePed")) then
                RageUI.DrawContent(
                    {header = true, glare = false, instructionalButton = false},
                    function()
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    if GetEntityHealth(PlayerPedId()) > 102 then
                                        tRNG.loadCustomisationPreset("DefaultMale")
                                    else
                                        tRNG.notify("Cannot change gender, you're dead.")
                                    end
                                end
                            end,
                            function()
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    if GetEntityHealth(PlayerPedId()) > 102 then
                                        tRNG.loadCustomisationPreset("DefaultFemale")
                                    else
                                        tRNG.notify("Cannot change gender, you're dead.")
                                    end
                                end
            ...
            if RageUI.Visible(RMenu:Get("RNGclothing", "changeClothing")) then
                RageUI.DrawContent(
                    {header = true, glare = false, instructionalButton = false},
                    function()
                        m = true
                                    ...
                                    function(L, M, N, O)
                                        ...
                                        if N then
                                            ...
                                            if k.index == 2 then
                                                ...
                                                TriggerServerEvent(
                                                    "RNG:saveClothingHairData",
                                                    GetPedDrawableVariation(tRNG.getPlayerPed(), 2),
                                                    GetPedHairColor(tRNG.getPlayerPed())
                                                )
            ...
            if RageUI.Visible(RMenu:Get("RNGclothing", "clearProps")) then
                RageUI.DrawContent(
                    {header = true, glare = false, instructionalButton = false},
                    function()
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tRNG.getPlayerPed(), 0)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tRNG.getPlayerPed(), 1)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tRNG.getPlayerPed(), 2)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tRNG.getPlayerPed(), 6)
                                end
                            end,
                            function()
                            end,
                        ...
                        RageUI.Button(
                            ...
                            function(L, M, N)
                                if N then
                                    ClearPedProp(tRNG.getPlayerPed(), 7)
                                end
                            end,
                            function()
                            end,
...
function current_clothing(P, i, R)
    if P == "prop" then
        if R then
            if GetPedPropTextureIndex(tRNG.getPlayerPed(), i) ~= nil then
                return GetPedPropTextureIndex(tRNG.getPlayerPed(), i)
            else
                return 0
            end
        else
            if GetPedPropIndex(tRNG.getPlayerPed(), i) ~= nil then
                if GetPedPropIndex(tRNG.getPlayerPed(), i) == -1 then
                    return GetPedPropIndex(tRNG.getPlayerPed(), i) + 2
                else
                    return GetPedPropIndex(tRNG.getPlayerPed(), i) + 1
                end
            else
                return 0
            end
    ...
    elseif P == "drawable" then
        ...
        elseif R then
            if GetPedTextureVariation(tRNG.getPlayerPed(), i) ~= nil then
                return GetPedTextureVariation(tRNG.getPlayerPed(), i)
            else
                return 0
            end
        else
            if GetPedDrawableVariation(tRNG.getPlayerPed(), i) ~= nil then
                return GetPedDrawableVariation(tRNG.getPlayerPed(), i) + 1
            else
                return 0
            end
        end
...
function get_textures(S, P, i)
    if S == "drawable" then
        ...
        j = GetNumberOfPedTextureVariations(tRNG.getPlayerPed(), P, i - 1)
        return j
    else
        j = GetNumberOfPedPropTextureVariations(tRNG.getPlayerPed(), P, i - 1)
        return j
    end
end
local function X()
...
Citizen.CreateThread(
    function()
        while true do
            if k.index ~= nil and RageUI.Visible(RMenu:Get("RNGclothing", "changeClothing")) then
    ...
    function(D, E)
        if E then
            for a4, a5 in pairs(r) do
                tRNG.addBlip(a5.x, a5.y, a5.z, 73, 3, "Clothing Store", 0.7)
                tRNG.addMarker(a5.x,a5.y,a5.z,0.6,0.6,0.6,10,255,81,170,50,9,false,false,true,"dp_clothing","top",90.0,90.0,0.0)
            end
        end
    end
)

-- local previousComponents = {}
...
-- local function areComponentsDifferent(oldComponents, newComponents)
--     for i = 0, 11 do
--         if oldComponents[i].drawable ~= newComponents[i].drawable or
--            oldComponents[i].texture ~= newComponents[i].texture or
--            oldComponents[i].palette ~= newComponents[i].palette then
--             return true
--         end
--     end
--     return false
...
--             local currentComponents = getPedComponents(playerPed)

--             if previousComponents[1] == nil then
--                 previousComponents = currentComponents
--             end

--             if areComponentsDifferent(previousComponents, currentComponents) and not IsInClothingMenu and not MenuOpened and not WasRecentlyInMenu() and not IsInWardrobeMenu and not IsInPedMenu then
--                 previousComponents = currentComponents
--                 TriggerServerEvent("RNG:anticheat:OutfitCopy", currentComponents)
--                 TriggerServerEvent("RNG:AnticheatFlag", "Copying Outfits")
--             end
--         end
--     end
-- end)