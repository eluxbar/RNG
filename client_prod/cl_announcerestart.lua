RegisterNetEvent("RNG:announceRestart")
AddEventHandler(
    "RNG:announceRestart",
    function(a, b)
...
RegisterNetEvent(
    "RNG:smallAnnouncement",
    function(g, h, i, j)
        tRNG.announceMpSmallMsg(g, h, i, j)
    end
)
function tRNG.announceMpSmallMsg(g, h, i, j)
