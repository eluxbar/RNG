...
function isPositionInPositions(currentPos, pos1, pos2)
    ...
    if currentPos.x >= minX and currentPos.x <= maxX and currentPos.y >= minY and currentPos.y <= maxY and currentPos.z >= minZ and currentPos.z <= maxZ then
        return true
    else
        return false
    end
