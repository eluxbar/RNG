...
cfg.nhsRanks = {
    ...
    {"NHS Trainee Paramedic", 60000, "nhs.rapist.whitelisted"},
    {"NHS Paramedic", 60000, "nhs.neurologist.whitelisted"},
    {"NHS Critical Care Paramedic", 60000, "nhs.experiencedparamedic.whitelisted"},
    {"NHS Junior Doctor", 67500, "nhs.doctor.whitelisted"},
    {"NHS Doctor", 75000, "nhs.seniordoctor.whitelisted"},
    {"NHS Senior Doctor", 82500, "nhs.specialist.whitelisted"},
    {"NHS Specialist Doctor", 90000, "nhs.consultant.whitelisted"},
    {"NHS Surgeon", 97500, "nhs.captain.whitelisted"},
    {"NHS Specialist Surgeon", 90000, "nhs.advisor.whitelisted"},
    {"NHS Assistant Medical Director", 105000, "nhs.deputychief.whitelisted"},
    {"NHS Deputy Medical Director", 112500, "nhs.assistantchief.whitelisted"},
