...
cfg.items = {
  ...
  -- Misc
  ["burnerphone"] = {"Burner Phone", "", nil, 5.00},
  ["scratchcard"] = {"Scratch Card", "", nil, 1},
  ["heavyarmour"] = {"Heavy Armour", "", nil, 7.50},
  ["lightarmour"] = {"Light Armour", "", nil, 5.00},
  ["stimshot"] = {"Stimshot", "", nil, 5.00},
}
...
local function load_item_pack(name)
  ...
  if items then
    ...
    print("[RNG] item pack ["..name.."] not found")
  end
end
