...
function loadCrosshairKvp()
    populateArrays()
    local isEnabled = GetResourceKvpInt("rng_crosshair_enabled")
    if isEnabled == 0 then
    ...
    local useCenterDot = GetResourceKvpInt("rng_crosshair_center_dot_enabled")
    ...
    local crosshairVisibility = GetResourceKvpInt("rng_crosshair_visibility")
    ...
    local crosshairLength = GetResourceKvpInt("rng_crosshair_length")
    ...
    local crosshairThickness = GetResourceKvpInt("rng_crosshair_thickness")
    ...
    local crosshairGap = GetResourceKvpInt("rng_crosshair_gap")
    ...
    local red = GetResourceKvpInt("rng_crosshair_red")
    if red == 0 then
    ...
    local green = GetResourceKvpInt("rng_crosshair_green")
    if green == 0 then
    ...
    local blue = GetResourceKvpInt("rng_crosshair_blue")
    if blue == 0 then
...
function saveCrosshair()
    SetResourceKvpInt('rng_crosshair_enabled', cfg.options.enabled)
    SetResourceKvpInt('rng_crosshair_center_dot_enabled', cfg.options.centerDotEnabled)
    SetResourceKvpInt('rng_crosshair_visibility', cfg.options.visibility)
    SetResourceKvpInt('rng_crosshair_length', cfg.options.length.index)
    SetResourceKvpInt('rng_crosshair_thickness', cfg.options.thickness.index)
    SetResourceKvpInt('rng_crosshair_gap', cfg.options.gap.index)
    SetResourceKvpInt('rng_crosshair_red', cfg.options.colour.red)
    SetResourceKvpInt('rng_crosshair_blue', cfg.options.colour.blue)
    SetResourceKvpInt('rng_crosshair_green', cfg.options.colour.green)
end
