...
cfg.stores = {
	["JDSports"] = {
		...
		["Green Hiking Backpack (+40kg)"] = {5, 117, 1,120000,40},
		["Tan Hiking Backpack (+40kg)"] = {5, 117, 0,120000,40},
		["Gucci Bag (+20kg)"] = {5, 116, 0,60000,20},
		["Off White Bag (+15kg)"] = {5, 114, 0,40000,15},
		["Nike Bag (+30kg)"] = {5, 112, 0,80000,30},
	...
	["Rebel"] = {
		...
		["Rebel Backpack (+70kg)"] = {5, 120, 0,250000,70},
	},
