...
cfg.items = {
    ...
    ["melee_import"] = {
        name = "Melee Import",
        description = "To use this item open a Weapon Ticket in the RNG Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["pistol_import"] = {
    ...
    ["rng_plus"] = {
        name = "RNG Plus (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["rng_platinum"] = {
        name = "RNG Platinum (30 Days)",
        manuallyRedeemable = true,
        canTransfer = true
    },
    ["supporter"] = {
    ...
    ["lock_slot"] = {
        name = "Lock Slot",
        description = "To use this item open a Ticket in the RNG Support Tickets Discord.",
        manuallyRedeemable = false,
        canTransfer = true
    },
    ["import_slot"] = {
        name = "Import Slot",
        description = "To use this item as an import slot open a Ticket in the RNG Support tickets Discord.",
        manuallyRedeemable = true,
        canTransfer = true,
        args = "import_slot"
    },
