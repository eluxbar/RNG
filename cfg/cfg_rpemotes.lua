...
RP.Shared = {
    ...
    ["carryfr"] = { -- Male Custom emote by RNG Mods
    ...
    ["carryfr2"] = { -- Female Custom emote by RNG Mods
...
RP.PropEmotes = {
    ...
    ["mshakee"] = {
        ...
        AnimationOptions = {
            Prop = 'brum_cherryshake_doublrngcolate',
            PropBone = 28422,
            PropPlacement = {
               0.0030,
                0.0280,
    ...
    ["skatesit"] = { -- Custom Emote By RNG Mods
        "skateboardposefranimation",
        "skateboardposerng_clip",
        "Skateboard - Sit",
        AnimationOptions = {
